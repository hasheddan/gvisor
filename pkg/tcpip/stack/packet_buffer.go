...
// RemoteLinkAddress returns the remote link address of the incoming packet
// this packet buffer holds.
func (pk *PacketBuffer) RemoteLinkAddress() tcpip.LinkAddress {
